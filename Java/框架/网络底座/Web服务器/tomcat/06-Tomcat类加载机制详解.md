...
> 本篇聚焦 Tomcat 的**类加载机制**（WebAppClassLoader 与双亲委派的关系），是 [05-Tomcat类加载机制剖析](05-Tomcat类加载机制剖析.md) 的深度展开篇。
> 前置知识：[Java类加载机制与双亲委派详解](../../../../JVM/Java类加载机制与双亲委派详解.md)（JDK 侧的双亲委派模型）
> 系列索引：[00-Tomcat总览](00-Tomcat总览.md)
...
- 详细热部署机制见 [Java类加载机制与双亲委派详解](../../../../JVM/Java类加载机制与双亲委派详解.md) 第 6 节（类唯一性 + 自定义 ClassLoader 代码）
...
- 关联笔记：[Java类加载机制与双亲委派详解](../../../../JVM/Java类加载机制与双亲委派详解.md)（JDK 侧机制）、[Java SPI机制详解](../../../../JDK基础库/核心机制/Java SPI机制详解.md)（另一种打破方式：线程上下文类加载器）
