...
> 关联笔记：[07-SpringBoot异步与线程池详解](../springboot/07-SpringBoot异步与线程池详解.md)（@Async 异步）、[05-Spring与SpringMVC整合详解](05-Spring与SpringMVC整合详解.md)（容器）
...
**异步坑**：@Async 监听器异常不外抛（"蒸发"），必须方法内 try-catch 或配置 `AsyncUncaughtExceptionHandler`（见 [07-SpringBoot异步与线程池详解](../springboot/07-SpringBoot异步与线程池详解.md)）。
...
- [07-SpringBoot异步与线程池详解](../springboot/07-SpringBoot异步与线程池详解.md)：@Async 异步监听
