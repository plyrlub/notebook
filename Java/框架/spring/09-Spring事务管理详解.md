...
> 前置知识：[07-Spring核心·AOP详解](07-Spring核心·AOP详解.md)（@Transactional 本质是一个 AOP 切面）、[Java注解机制详解](../../JDK基础库/核心机制/Java注解机制详解.md)（注解如何被处理）
> 关联笔记：[Java代理详解](../../JDK基础库/核心机制/Java代理详解.md)（代理机制）、[Java参数校验详解](../通用实践/Java参数校验详解.md)（同属 springboot 框架知识域）
...
Spring 声明式事务的核心：**@Transactional 只是一个标记，真正生效靠 AOP 代理**（呼应 [Java注解机制详解](../../JDK基础库/核心机制/Java注解机制详解.md)："注解只是元数据，处理者赋予意义"）。
...
> 指引：**[04-分布式事务详解](../../../分布式/核心原理/04-分布式事务详解.md)**（理论/模型/Seata）、**[Seata分布式事务框架详解](../../中间件/分布式协调/分布式事务/Seata分布式事务框架详解.md)**
...
- 关联：[07-Spring核心·AOP详解](07-Spring核心·AOP详解.md)（事务切面原理）、[Java注解机制详解](../../JDK基础库/核心机制/Java注解机制详解.md)（注解扫描机制）
