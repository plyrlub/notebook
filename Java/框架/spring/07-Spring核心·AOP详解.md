...
> 前置知识：[Java注解机制详解](../../JDK基础库/核心机制/Java注解机制详解.md)（注解如何被处理）、[Java代理详解](../../JDK基础库/核心机制/Java代理详解.md)（动态代理基础）
> 关联笔记：[09-Spring事务管理详解](09-Spring事务管理详解.md)（AOP 的典型应用）、[Java Agent与字节码增强详解](../../JDK基础库/核心机制/Java Agent与字节码增强详解.md)（另一种增强方式）
...
这就是"注解 + AOP"的经典组合：**注解只是标记，切面通过 @annotation 切点读取它并赋予行为**（呼应 [Java注解机制详解](../../JDK基础库/核心机制/Java注解机制详解.md) 的"处理者"概念）。

## 五、完整示例：注解 + 切面闭环

接口幂等拦截（完整闭环，来自 [Java注解机制详解](../../JDK基础库/核心机制/Java注解机制详解.md) 的面试场景）：
...
- 关联：[Java代理详解](../../JDK基础库/核心机制/Java代理详解.md)（JDK 动态代理/CGLIB 原理）、[Java注解机制详解](../../JDK基础库/核心机制/Java注解机制详解.md)（注解如何被切面读取）
