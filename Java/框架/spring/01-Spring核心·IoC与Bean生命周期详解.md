...
> 前置知识：[Java反射详解](../../JDK基础库/核心机制/Java反射详解.md)（反射 getAnnotation/newInstance，容器底层）、[Java注解机制详解](../../JDK基础库/核心机制/Java注解机制详解.md)（@Component 注解扫描）
...
- [Java反射详解](../../JDK基础库/核心机制/Java反射详解.md)：容器靠反射 newInstance + setField 完成创建与注入
- [Java注解机制详解](../../JDK基础库/核心机制/Java注解机制详解.md)：@Component 是标记，Spring 扫描并注册为 Bean
...
![A↔B 循环依赖：三级缓存流转](assets/04-循环依赖三级缓存流转.svg)
