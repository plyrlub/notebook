...
> 前置知识：[01-Spring核心·IoC与Bean生命周期详解](01-Spring核心·IoC与Bean生命周期详解.md)（容器/Bean）、[Java反射详解](../../JDK基础库/核心机制/Java反射详解.md)（参数绑定底层）、**00-网络传输协议总览**（见知识库）（HTTP）
...
- [Java反射详解](../../JDK基础库/核心机制/Java反射详解.md)：HandlerAdapter 用反射调用控制器方法 + 参数转换
...
- 参数校验用 Bean Validation（@Valid + 校验注解），见 [Java参数校验详解](../通用实践/Java参数校验详解.md)
...
- [Java参数校验详解](../通用实践/Java参数校验详解.md)：@Valid 参数校验
- 安全域 [01-Spring Security核心架构详解](../安全/01-Spring Security核心架构详解.md)：Spring Security 基于 MVC 过滤链
