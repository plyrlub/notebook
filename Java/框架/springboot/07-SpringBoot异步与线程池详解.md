...
> 前置知识：[07-Spring核心·AOP详解](../spring/07-Spring核心·AOP详解.md)（动态代理/自调用失效）、[01-Java线程池原理与参数详解](../../JDK基础库/并发/线程池/01-Java线程池原理与参数详解.md)（线程池核心参数）
> 关联笔记：[09-Spring事务管理详解](../spring/09-Spring事务管理详解.md)（@Transactional 与 @Async 同属代理注解，失效原因相通）、[09-SpringBoot日志配置详解](09-SpringBoot日志配置详解.md)（异步日志线程池）
...
- 长耗时异步任务占满线程池 → 监控线程池指标（配合 [11-SpringBoot Actuator监控详解](11-SpringBoot Actuator监控详解.md)）
...
- 上一篇：[06-SpringBoot自定义Starter实践](06-SpringBoot自定义Starter实践.md)
...
- [09-SpringBoot日志配置详解](09-SpringBoot日志配置详解.md)：异步日志线程池
