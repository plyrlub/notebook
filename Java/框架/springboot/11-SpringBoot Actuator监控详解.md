...
> 关联笔记：[07-SpringBoot异步与线程池详解](07-SpringBoot异步与线程池详解.md)（线程池指标）、[09-SpringBoot日志配置详解](09-SpringBoot日志配置详解.md)（日志与监控）、[13-Spring WebFlux响应式编程详解](13-Spring WebFlux响应式编程详解.md)（响应式监控）
...
- `env`/`heapdump`/`threaddump` 敏感，生产结合 Spring Security 或防火墙保护（见安全域 [01-Spring Security核心架构详解](../安全/01-Spring Security核心架构详解.md)）
...
- 线程池指标：`/actuator/metrics/jvm.threads.*` 等（呼应 [07-SpringBoot异步与线程池详解](07-SpringBoot异步与线程池详解.md)）
...
- 上一篇：[10-SpringBoot日志配置实践](10-SpringBoot日志配置实践.md)
- 下一篇：[12-SpringBoot Actuator监控实践](12-SpringBoot Actuator监控实践.md)
- [07-SpringBoot异步与线程池详解](07-SpringBoot异步与线程池详解.md)：线程池指标监控
- [09-SpringBoot日志配置详解](09-SpringBoot日志配置详解.md)：日志与监控协同
- 安全域 [01-Spring Security核心架构详解](../安全/01-Spring Security核心架构详解.md)：Actuator 端点鉴权
