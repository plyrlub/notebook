...
> 关联笔记：[00-构建工具总览·Maven & Gradle选型对比](../00-构建工具总览·Maven & Gradle选型对比.md)、[01-依赖与仓库](../Maven/01-依赖与仓库.md)
...
- [00-构建工具总览·Maven & Gradle选型对比](../00-构建工具总览·Maven & Gradle选型对比.md)——两者定位差异先建立
...
[02-Gradle Task与生命周期详解](02-Gradle Task与生命周期详解.md)——Task 声明/依赖/增量构建原理
