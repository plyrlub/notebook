...
- [一致性Hash算法详解](分布式/01-核心原理/01-一致性Hash算法详解.md)
    Hash 环、虚拟节点、数据倾斜、Redis 哈希槽/Nginx 对照
- [CAP与BASE理论详解](分布式/01-核心原理/02-CAP与BASE理论详解.md)
    CAP 定理、BASE 理论、一致性模型、选型
- [分布式锁原理详解](分布式/01-核心原理/03-分布式锁原理详解.md)
    Redis/Zookeeper 实现、防死锁、可重入、Redlock
- [分布式事务详解](分布式/01-核心原理/04-分布式事务详解.md)
    2PC/3PC、TCC、Saga、本地消息表、选型
- [分布式ID与幂等设计详解](分布式/01-核心原理/05-分布式ID与幂等设计详解.md)
    雪花算法、UUID、号段模式、防重复提交
- [负载均衡详解](分布式/01-核心原理/06-负载均衡详解.md)
    四层 vs 七层模型、LVS/HAProxy/Nginx/Envoy、调度算法、高可用选型
- [Raft与Paxos共识算法详解](分布式/01-核心原理/07-Raft与Paxos共识算法详解.md)
    Raft 选举/日志复制/安全性、Paxos 思想、ZAB 三方对比
- [分布式Session详解](分布式/01-核心原理/09-分布式Session详解.md)
