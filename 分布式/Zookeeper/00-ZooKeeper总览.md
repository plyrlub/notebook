...
> 关联笔记：[03-分布式锁原理详解](../核心原理/03-分布式锁原理详解.md)（Redis 锁对照）、[04-Apache Dubbo详解](../../Java/框架/服务通信/04-Apache Dubbo详解.md)、[02-XXL-Job详解](../../Java/框架/定时任务/02-XXL-Job详解.md)（注册中心）
...
- [03-分布式锁原理详解](../核心原理/03-分布式锁原理详解.md)——分布式锁对照（ZooKeeper 锁 vs Redis 锁）
