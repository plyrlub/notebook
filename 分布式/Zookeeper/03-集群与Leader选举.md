...
> 关联笔记：[04-ZAB协议与一致性](04-ZAB协议与一致性.md)（选举与同步的协议层基础）、[02-CAP与BASE理论详解](../01-核心原理/02-CAP与BASE理论详解.md)
...
---
*创建于 2026-08-09（wolai 笔记转存 + 网络查证补充），2026-08-11 细化（补角色职责图/选举时序图/同步方式选择流程/请求处理链图/集群规模对比表）*
