...
> 关联笔记：[03-分布式锁原理详解](../01-核心原理/03-分布式锁原理详解.md)（Redis 锁对照）、[01-数据模型与节点详解](01-数据模型与节点详解.md)
...
- [03-分布式锁原理详解](../01-核心原理/03-分布式锁原理详解.md)——锁的对比视角
- 需掌握：Java、Maven
...
> 对比见 [03-分布式锁原理详解](../01-核心原理/03-分布式锁原理详解.md)：ZK 锁无死锁风险但性能低于 Redis 锁；Redis 锁快但有锁超时/主从切换风险。
